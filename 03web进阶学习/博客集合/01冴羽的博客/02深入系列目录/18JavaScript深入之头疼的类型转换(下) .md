...
![](https://camo.githubusercontent.com/89262761f091b06f8d6a85e3eaa68337961bc93c/68747470733a2f2f67772e616c6963646e2e636f6d2f7466732f5442315737704941585937674b306a535a4b7a585861696b7058612d313032322d38322e6a7067)

我们刚才才说过 `{} + []` 的结果是 "[object Object]" 呐，这怎么变成了 0 了？

不急，我们尝试着加一个括号：
![](https://camo.githubusercontent.com/ab84b513dd879ba3fdce63ac535d5538ed46d93d/68747470733a2f2f67772e616c6963646e2e636f6d2f7466732f5442316a4d384b41686e31674b306a535a4b5058585876555858612d313132342d37362e6a7067)
...
> 2.  x 是 null 并且 y 是 undefined，返回 true<br/>
> 3.  x 是 undefined 并且 y 是 null，返回 true
...
> 4. x 是数字，y 是字符串，判断 x == ToNumber(y)<br/>
> 5. x 是字符串，y 是数字，判断 ToNumber(x) == y
...
> 8.  x 不是字符串或者数字，y 是对象，判断 x == ToPrimitive(y)<br/>
> 9.  x 是对象，y 不是字符串或者数字，判断 ToPrimitive(x) == y
