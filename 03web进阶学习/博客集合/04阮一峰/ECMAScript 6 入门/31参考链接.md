...
- Axel Rauschmayer, [ES proposal: global](http://www.2ality.com/2016/09/global.html): 顶层对象global
...
- Axel Rauschmayer, [ES proposal: arbitrary precision integers](http://ponyfoo.com/articles/es6-number-improvements-in-depth)
...
- Jason Orendorff,[ ES6 In Depth](https://hacks.mozilla.org/2015/06/es6-in-depth-collections/): Collections：Set 和 Map 结构的设计思想
- Axel Rauschmayer, [Converting ES6 Maps to and from JSON](https://hacks.mozilla.org/2015/06/es6-in-depth-collections/): 如何将 Map 与其他数据结构互相转换
## 13. Proxy 和 Reflect
...
- Keith Cirkel, [Metaprogramming in ES6: Part 2](https://www.keithcirkel.co.uk/metaprogramming-in-es6-part-2-reflect/) - Reflect: Reflect API 的详细介绍
## 14. Promise 对象
...
- Ronald Chen, [How to escape Promise Hell:](https://medium.com/@pyrolistical/how-to-get-out-of-promise-hell-8c20e0ab0513#.2an1he6vf) 如何使用Promise.all方法的一些很好的例子
...
- Yehuda Katz, [TC39: Promises](https://thefeedbackloop.xyz/tc39-promises-promises/), Promises: Promise.try() 的用处
## 15. Iterator
...
- Axel Rauschmayer, [Iterators and generators in ECMAScript 6](http://www.2ality.com/2015/02/es6-iteration.html): 探讨 Iterator 和 Generator 的设计目的
...
- Axel Rauschmayer, [ES proposal: import() – dynamically importing ES modules: import()](http://www.2ality.com/2017/01/import-operator.html) 的用法
