...
- [| 访问权限       | 任意窗口                                                                     | 任意窗口           | 当前页面窗口                     |](#-访问权限--------任意窗口----------------------------------------------------------------------任意窗口------------当前页面窗口---------------------)
...
- [js网络请求性能优化之防抖与节流](#js网络请求性能优化之防抖与节流)
  ...
  - [区别](#区别)
- [如何做到修改url参数页面不刷新](#如何做到修改url参数页面不刷新)
...
- [为什么 WeakMap 和 WeakSet 的键只能使用对象？](#为什么-weakmap-和-weakset-的键只能使用对象)
- [- JavaScript高级程序设计（第4版）](#--javascript高级程序设计第4版)
<<<<<<< HEAD
- [如何做到修改url参数页面不刷新](#如何做到修改url参数页面不刷新)
- [格式化金钱，每千分位加逗号](#格式化金钱每千分位加逗号)
- [请用js去除字符串空格](#请用js去除字符串空格)
...
- [为什么 WeakMap 和 WeakSet 的键只能使用对象？](#为什么-weakmap-和-weakset-的键只能使用对象)
=======
>>>>>>> 1e2e1ce67a3d248ed025642a200607c174d4e849
...
1. `CommonJS` 模块使用 `require()` 和 `module.exports`，ES6 模块使用 import和 export。
