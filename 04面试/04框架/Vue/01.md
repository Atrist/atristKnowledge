...
Object.defineProperty到底有什么作用呢？ [MDN](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Object/defineProperty)
```bash
...
我们需要用到的就是描述符当中的`getter`和`setter`
```js
const obj = {a:1}
obj.a // 1
